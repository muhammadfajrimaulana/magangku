...
class _KelolaProfilDetailState extends State<KelolaProfilDetail> {
  ...
  Future<void> _loadInitialData() async {
    ...
    if (widget.role == 'admin') {
      ...
      print('Ambil nama dari data mahasiswa: $nama, foto: $fotoProfil');
    }
          ...
          if (data['success'] == true) {
            ...
            if (widget.role == 'mahasiswa') {
              ...
              if (newFotoProfilPath != null && newFotoProfilPath.isNotEmpty) {
                ...
                print(
                  'Menyimpan fotoProfilMahasiswa ke SharedPreferences: $newFotoProfilPath',
                );
                setState(() {
                  _fotoProfilPath = newFotoProfilPath;
                  _image = null;
                  print(
                    'setState dipanggil, _fotoProfilPath sekarang: $_fotoProfilPath',
                  );
                });
              }
            } else if (widget.role == 'admin') {
              ...
              if (newFotoProfilPath != null && newFotoProfilPath.isNotEmpty) {
                ...
                print(
                  'Menyimpan fotoProfilAdmin ke SharedPreferences: $newFotoProfilPath',
                );
                setState(() {
                  _fotoProfilPath = newFotoProfilPath;
                  _image = null;
              ...
              if (newFotoProfilPath != null && newFotoProfilPath.isNotEmpty) {
                ...
                print(
                  'Menyimpan fotoProfilPembimbing ke SharedPreferences: $newFotoProfilPath',
                );
                setState(() {
                  _fotoProfilPath = newFotoProfilPath;
                  _image = null;
